...
import { Briefcase, BookOpen, ChevronDown } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  // Navigation data - Only working features
  const navSections = [
    {
      title: 'Employers',
      icon: <Briefcase className="h-4 w-4" aria-hidden="true" />,
      items: [
        { label: 'Employer Directory', href: '/defense-jobs' },
        { label: 'Search Employers', href: '/job-search' },
