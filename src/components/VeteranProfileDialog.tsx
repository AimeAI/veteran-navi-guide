  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-4xl flex flex-col max-h-[90vh] overflow-hidden z-[100]">
        ...
        <DialogFooter className="sticky bottom-0 bg-background pt-4 pb-2 sm:justify-between flex flex-col-reverse sm:flex-row gap-2 mt-4 border-t border-gray-100">
          <DialogClose asChild>
